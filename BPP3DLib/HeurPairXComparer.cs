...
namespace BPP3DLib
{
    public struct HeurPairXComparer : IComparer<HeuristicPair>
    {

        // Compare two heuristic pairs by Depth.
        public int Compare(HeuristicPair a, HeuristicPair b)
        {
            // Depth decreasing order.
            int r;
            r = b.D - a.D;
            if (r != 0)
            {
