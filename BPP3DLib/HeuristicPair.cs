...
namespace BPP3DLib
{
    /* structure for heuristic algorithm */
    public struct HeuristicPair
    {
        int layNo;              // Layer number                          */
        int d;                  // Depth of layer                        */
        int binNoLay;           // Bin no assigned to layer              */
        int z;                  // z-level of layer within bin           */
        int b;                  // Temporary bin number                  */

        public int LayNo { get => layNo; set => layNo = value; }
        public int D { get => d; set => d = value; }
        public int BinNoLay { get => binNoLay; set => binNoLay = value; }
